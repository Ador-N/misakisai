...
label day3:
    ...
    "伴随着麻雀的鸣叫，闹钟的声音响起了。"
    window hide
    show bg 主人公部屋（朝） at center with pixellate
...
label day3_1_tomo_sinobu:
    ...
    window hide
    show cg c34 1 at center with lm_crossfade
    window show
    me "哈哈，你们俩关系真好啊。"
    tomo "是啊！我们可是发小啊！"
    sinobu "……嗯。"
...
label day3_2_tomo:
    ...
    stop music fadeout 0.5
    play music "tomo.ogg"
    show cg c13 at center with lm_crossfade
    window show
    "友拿出2个便当，然后其中的一个递给了我。"
    me "诶，这个，难道说……？"
    "是友君亲手做的便当！？？？"
...
label day3_2_sinobu:
    ...
    show bg 階段 with dissolve
    pause 0.4
    play music "FX/喧騒.ogg"
    show bg 食堂 with Dissolve(2.0)
    window show
    "我来到充满活力的食堂，翻看着菜单。"
    me "真怀念啊~。"
    extend "\n呃……要做什么呢。"
    ...
    "然后，我和忍就各拿了一份大碗煮荞麦面。"
    window hide
    show bg 食堂 at center with dissolve
    ...
    extend "\n倒不如说，我很开心！"
    window hide
    show cg c36 at center with lm_crossfade
    window show
    sinobu "……我也很开心哦。"
...
label day3_2_futago:
    ...
    window hide
    show cg c53 at center with lm_crossfade
    window show
    "月这么说着，把和自己那盒便当不一样的\n另一个便当从袋子里取了出来。"
    me "真的吗！？"
    extend "\n哇啊啊~！！好开心啊！\n谢谢你特意带过来！！！"
...
label day3_2_sintarou:
    ...
    window hide
    show cg c27 at center with lm_crossfade
    window show
    sintarou "久等了~！"
    extend "\n给你！\n这是热乎乎的关东煮哦。"
...
label day3_2_tubasa:
    ...
    hide bg with dissolve
    stop music fadeout 0.5
    show bg 階段 at center with dissolve
    pause 0.4
    play music "FX/喧騒.ogg"
    show bg 食堂 with Dissolve(2.0)
    window show
    ...
    window hide
    play music "回想.ogg"
    show cg c44 at center with Dissolve(1.5)
    window show
    ...
    window hide
    hide cg with lm_effect_20
    hide tubasa with lm_effect_20
    window show
    me "原来如此。"
    extend "\n然后，在和他相处的过程中，被他吸引了，"
    extend "\n已经渐渐地产生了超越普通朋友的感情了吧。"
...
label day3_2_saburo:
    ...
    saburo "没那个必要啦♪"
    window hide
    show cg c70 at center with lm_crossfade
    window show
    "这样说着，三朗向我展示了他手上的塑料袋。"
    ...
    window hide
    stop music fadeout 0.5
    show cg 空 at center with Dissolve(0.8)
    play music "saburo.ogg"
    window show
    saburo "来，这是你的，这是我的！"
    "三朗一边说着，一边把饭盒递给了我。"
...
label day3_2_sakuya:
    ...
    "……啊，总觉得这种感觉……稍微有点不错呢。"
    window hide
    show cg c79 at center with lm_crossfade
    window show
    sakuya "怎么了？还在笑？"
    me "不，稍微有点吧。"
    extend "\n一想到和作哉君是朋友，就有点忍不住。"
...
label day3_cooking:
    ...
    hide bg with dissolve
    play sound "FX/引き戸.ogg"
    show bg 家庭科室 with Dissolve(0.8)
    window show
    ...
    hide sora with dissolve
    hide bg with dissolve
    show bg 家庭科室 at center with Dissolve(0.8)
    ...
    window hide
    show cg 校舎（夕方 with Dissolve(1.0)
    pause 0.7
    hide tuki with dissolve
    hide sora with dissolve
    hide cg with dissolve
...
label day3_supply:
    ...
    show bg 通学路 at center with dissolve
    pause 0.5
    show bg 街中 with dissolve
    pause 0.5
    play music "梅咲２.ogg"
    show bg デパート１ with Dissolve(1.5)
...
label day3_design_tomo:
    ...
    window hide
    play music "大変だ！.ogg"
    show cg c15 at center with lm_crossfade
    play sound "FX/可愛い.ogg"
    window show
    "啪嗒"
    extend "\n啪嗒"
...
label day3_design_sintarou:
    ...
    window hide
    play music "大変だ！.ogg"
    show cg c28 at center with lm_crossfade
    play sound "FX/可愛い.ogg"
    window show
    "啪嗒"
    extend "\n啪嗒"
...
label day3_layout_sinobu_unused:
    ...
    window hide
    play music "sinobu.ogg"
    show cg c35 1 at center with lm_crossfade
    window show
    sinobu "您好，海老师。"
    extend "\n我是二年一班的绫濑。"
...
label day3_cooking_tuki:
    ...
    hide bg with dissolve
    play sound "FX/引き戸.ogg"
    show bg 廊下（夕方） at center with dissolve
    play music "静かな昼休み.ogg"
    window show
    ...
    pause 0.6
    show bg 教室（夕方） with Dissolve(1.0)
    window show
    "幸运的是，隔壁教室空无一人。"
    ...
    play music "急げ～！.ogg"
    window hide
    show cg c62 1 at center with lm_flash
    play sound "FX/可愛い2.ogg"
    window show
    me "接下来就擦掉你校服上沾的牛奶吧。"
    tuki "喂，喂！"
    ...
    hide sora with dissolve
    play music "twins.ogg"
    show bg 教室（夕方） at center with Dissolve(1.0)
    window show
    ...
    window hide
    show cg 校舎（夕方 at center with Dissolve(0.8)
    window show
...
label day3_cooking_sora:
    ...
    play music "急げ～！.ogg"
    window hide
    show cg c55 1 at center with lm_flash
    play sound "FX/ビヨン.ogg"
    window show
    "空的手伸向了我的制服。"
    me "诶，等等！ 空？？"
    ...
    show cg c56 at center with pixellate
    play sound "FX/ひらめき！.ogg"
    "偷看"
    window hide
...
label day3_layout_2:
    ...
    show cg c12 2 at center with pixellate
    hide tubasa with dissolve
    hide sinobu with dissolve
    window show
    ...
    hide tubasa with dissolve
    play music "静かな昼休み.ogg"
    show bg 音楽室（夕方） at center with dissolve
    window show
    me "呼~……总算是平平安安地过去了……。"
...
label day3_layout_2_sinobu:
    ...
    window hide
    hide sinobu with dissolve
    show bg 歩道（夕方） with Dissolve(2.0)
    window show
    "我和忍一起走在回家的路上。"
    ...
    me "嗯？怎么了？"
    window hide
    show 夕空 夕方 at center with dissolve
    window show
    sinobu "空……晚霞好美啊。"
    me "真的…。"
    extend "\n不过，比起晚霞，我还是更喜欢忍的笑容…。"
    ...
    show bg 歩道（夕方） at center with Dissolve(1.0)
...
label day3_layout_2_tubasa:
    ...
    "如同之前的早晨一样，翼失去了平衡，\n连带着牵着他的我的手一起摔在了地上。"
    window hide
    show cg c45 1 at center with pixellate
    window show
    "面前是翼的脸。"
    extend "\n比以往都要近得多的距离。"
    me "……翼你的话，遇到这种情况，会怎么做？"
    ...
    extend "\n在弄清对方的心意之前，会顺势保持原状……。"
    me "……对啊。"
    show bg 夕方 at center
    "我从翼身上退下，抱起了他。"
    window hide
    hide tubasa with fade
    hide cg with fade
    window show
    me "嗯！没错！这样就行了！"
    extend "\n这才是男人嘛！！"
    ...
    window hide
    play music "良い雰囲気.ogg"
    show bg 歩道（夕方） with Dissolve(1.0)
    ...
    extend "\n比如说，什么样子的事情？"
    me "有一次，今崎在惩罚游戏里玩过跳伞……"
    show cg blue at center with Dissolve(0.7)
    "和翼在一起的时候，话题就一个接一个地冒出来。"
    extend "\n对，和翼在一起的时间就是这么愉快。"
    stop music fadeout 2.0
    window hide
    show cg 御咲駅（夕方 with Dissolve(0.9)
    window show
    "我一边想着，一边和翼享受着在一起的时光，\n在车站和翼分开后，我一个人步行回家。"
    window hide
    hide bg with dissolve
    ...
    pause 0.4
    play music "FX/燕.ogg"
    show bg 住宅街（夕方） at center with Dissolve(1.5)
    window show
    "就在这时，"
    window hide
    ...
    window hide
    pause 0.4
    show bg 住宅街（夕方） at center with Dissolve(1.0)
...
label day3_2_sora:
    ...
    show cg 校舎（朝 at center with Dissolve(0.7)
    tuki_and_me "哈哈哈哈。"
...
label day3_supply_2_saburo:
    ...
    window hide
    show bg ゲームセンター１ with Dissolve(1.0)
    window show
    me "诶。"
    extend "\n在这种地方居然还有游戏厅。"
    ...
    hide sakuya with dissolve
    hide bg with dissolve
    show bg ゲームセンター２ at center with Dissolve(0.8)
    window show
    ...
    window hide
    show cg c71 1 at center with fade
    window show
    ...
    "三朗定好目标，按下决定键，\n机械臂的嘴就张开，然后机械臂渐渐下降。"
    window hide
    show cg c72 2 with lm_crossfade
    window show
    ...
    window hide
    play music "可愛いおとぼけ.ogg"
    show cg c73 1 at center with lm_crossfade
    window show
    ...
    me "嗯……谢谢。"
    extend "\n会好好珍惜的。"
    hide saburo with fade
    hide cg with fade
    show saburo 10 at top with dissolve
    saburo "嘿嘿。"
    play sound "FX/バイブ.ogg"
    "嗡嗡……嗡嗡……"
    "突然，震动声响起。"
    show saburo 24 with dissolve
    saburo "嗯？是我的来电。"
    ...
    window hide
    play music "siro.ogg"
    show cg c74 at center with lm_crossfade
    window show
    saburo "嗯……就是这种家伙。"
    ...
    saburo "哇啊啊啊。\n所以别再说这么让人误解的话了~~！！"
    window hide
    show cg 夕方 at center with Dissolve(1.0)
    window show
    "就这样，我们在街机厅开心地玩了会儿后"
...
label day3_supply_2_sakuya:
    ...
    hide sakuya with dissolve
    hide bg with dissolve
    show bg 校舎（全貌） at center with lm_crossfade
    pause 0.5
    ...
    show cg c80 at center with lm_flash
    window show
    "这样说着，作哉把放着狗粮的包拿给三朗看。"
    play sound "FX/ダッ！.ogg"
    saburo "诶！！！"
    ...
    hide sakuya with dissolve
    play music "FX/燕.ogg"
    show bg 校庭 at center with lm_crossfade
    pause 0.4
    ...
    window show
    "草木丛生的地方传来了一阵窸窸窣窣的声音，\n不久，一个小小的脑袋从里头探了出来。"
    show ツバサ 2 at top with dissolve
    play sound "FX/可愛い.ogg"
    tubasa "汪！汪！"
    me "噢噢~！真的冒出来了！！"
    ...
    "小翼就像是在引导我们散步一样，\n精力充沛地在前方走着。"
    window hide
    show cg c81 at center with lm_crossfade
    window show
    me "啊哈哈。\n小翼看起来很开心呢~。"
    extend "\n很喜欢散步呢。"
    ...
    hide bg with dissolve
    play music "FX/燕.ogg"
    show bg 山道1 with Dissolve(0.7)
    pause 0.4
    show bg 山道２ with Dissolve(0.7)
    pause 0.4
    show bg 山道3 with Dissolve(1.0)
    ...
    hide bg with dissolve
    play music "FX/波.ogg"
    show bg 山道4 at center with Dissolve(1.0)
    window show
    "我们登上了山顶，眼前出现了一片湖泊。"
    sakuya "哇……好棒……"
    extend "\n我从来都不知道还有这么漂亮的地方……"
    ...
    me "啊，是啊……抱歉抱歉。"
    window hide
    show cg 夕方 at center with Dissolve(0.8)
    window show
    "我们暂时停止了对话，欣赏着美丽的风景。"
    extend "\n小翼依然在湖边跑着。"
    me "太阳落山了啊。"
    ...
    "作哉的眼眶里泪花闪烁。"
    window hide
    show cg c82 1 at center with lm_crossfade
    window show
...
label day3_design_2_tomo:
    ...
    window hide
    hide tomo with dissolve
    show bg 森海家アパート with Dissolve(1.5)
    window show
    "友所指的方向，是3层高的可爱公寓，\n其外观上有着淡茶色的砖瓦拼图。"
    ...
    window hide
    play sound "FX/ドアを開ける.ogg"
    show bg 森海家のリビング with Dissolve(1.5)
    ...
    window hide
    play music "tomo.ogg"
    show cg c16 at center with lm_flash
    window show
    play sound "FX/可愛い.ogg"
    tomo "喵ー！！好爽！！！\n居然撞到障碍了！！！"
    extend "\n哇啊ー！被他甩得越来越远了ー！"
    ...
    hide cg with dissolve
    hide bg with dissolve
    show bg 森海家のリビング（夕方） at center with dissolve
    window show
    me "呜……3D眩晕症要犯了。"
    ...
    hide tomo with dissolve
    play sound "FX/ドアを開ける.ogg"
    show bg 友部屋（夕方） with lm_effect_20
    window show
    ...
    extend "\n果然没什么！！"
    extend "\n那个……嗯！我，再稍微想一下！！"
    show cg yellow with Dissolve(0.7)
    "在这个梦的世界里，遇到了各种各样的少年。"
    extend "\n大家都很可爱。"
    extend "\n每个人都有各自的魅力，老实说，我也想象过。"
    "但是，现在，坐在眼前的这个人是……"
    ...
    hide tomo with dissolve
    play sound "FX/ドアを開ける.ogg"
    show bg 森海家アパート（夕方 with dissolve
    window show
    "就这样，我从友家出来，朝自己家走去。"
    window hide
    hide bg with dissolve
    pause 0.6
    show bg 月（夜） with Dissolve(1.0)
    pause 0.6
    play music "FX/夜　虫.ogg"
    show bg 森海家アパート（夜 with Dissolve(1.0)
    pause 0.8
    show bg 友部屋（夜） with Dissolve(2.0)
    ...
    extend "\n不过我觉得你也不用勉强去说就是了。"
    window hide
    show cg 月（夜） at center with dissolve
    window show
    tomo "……！"
    extend "\n再，再让我考虑一下。"
...
label day3_design_2_sintarou:
    ...
    window hide
    play music "FX/風.ogg"
    show cg セピア１ at center with pixellate
    window show
    me "在我恢复成现在这个样子之前，\n我在这里得到了一种叫做魔法糖的东西。"
    ...
    hide cg with fade
    hide bg with fade
    hide sintarou with fade
    pause 0.4
    play music "sintarou.ogg"
    show bg 公園 at center with Dissolve(0.8)
    ...
    "刚才的那个……能这么理解吗……？"
    window hide
    show bg 夕方 with Dissolve(0.7)
    pause 0.5
    show bg 住宅街（夕方） with Dissolve(0.75)
    pause 0.5
    show bg 花の湯（廊下） with Dissolve(1.5)
    ...
    "怀着懊悔的心情，我沮丧地走向了更衣室。"
    window hide
    show bg 脱衣所 at center with Dissolve(0.8)
    pause 0.5
    play sound "FX/引き戸.ogg"
    play music "FX/銭湯.ogg"
    show bg 花の湯 with Dissolve(1.5)
    window show
    "砰"
    "我沐浴过后，泡进了浴缸里。"
    "唰"
    ...
    "···"
    window hide
    show bg 花の湯 at center with dissolve
    window show
    "泡进浴池后不到几十分钟，"
    extend "\n我盯着打扫浴场的慎太郎，\n身体就像被钉在浴池里一样。"
    ...
    "···"
    window hide
    show bg 慎太郎部屋 at center with Dissolve(5.0)
    play music "良い雰囲気.ogg"
    window show
    "当我醒来时，发现自己看着陌生的天花板。"
    window hide
    ...
    me "！！"
    "我……难道是迷上了慎太郎吗……？"
    show cg orange at center with Dissolve(0.7)
    "在这个梦的世界里，遇到了各种各样的少年。"
    extend "\n大家都很可爱。"
    extend "\n每个人都有各自的魅力，老实说，我也想象过。"
    "但是，现在，坐在眼前的这个人是……"
...
label day3_layout_tubasa_2:
    ...
    hide tubasa with dissolve
    play music "tubasa.ogg"
    show cg c43 at center with fade
    window show
    "翼＆我" "啊…。"
    "扑通扑通扑通！！！"
    "心跳声更加激烈了。"
    ...
    me "哦，好！太好了。"
    extend "\n那我们就赶紧过去吧。"
    show cg 校舎（朝 at center with Dissolve(1.0)
    "没错。我现在是执行委员。"
...
label day3_supply_self:
    ...
    extend "\n那么，买好东西之后回学校吧。"
    window hide
    show cg 空 at center with Dissolve(0.7)
    window show
...
label day3_sirou:
    ...
    hide cg with dissolve
    play music "FX/燕.ogg"
    show bg 通学路 at center with Dissolve(0.7)
    pause 0.4
    show bg 歩道 with Dissolve(0.7)
    pause 0.4
    show bg 交差点 with Dissolve(1.2)
    window show
    ...
    window hide
    play music "siro.ogg"
    show cg c84 at center with lm_crossfade
    window show
    unknown "痛痛痛痛痛……"
    extend "\n啊……对，对不起！！\n你没事吧？"
    ...
    window hide
    show cg c85 at center with lm_crossfade
    window show
    unknown "那个……您不觉得重吗？"
    me "没问题的。"
    extend "\n倒不如说，感觉很舒服！"
