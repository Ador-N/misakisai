...
label day0_start:
    ...
    play sound "電車.ogg"
    pause 0.6
    show bg 夜の街 with Dissolve(2.0)
    pause 1.0
    hide bg with dissolve
    play sound "電車.ogg"
    show bg 電車内（夜） at center with Dissolve(0.7)
    pause 0.5
    window show
    ...
    show 少年たち c1 帰宅する少年たち at center with lm_crossfade
    pause 0.3
    show 少年たち c1 帰宅する少年たち２ with lm_crossfade
    window show
    me "啊，坐去梅咲的电车的话……"
    ...
    "没错，我是正太控。"
    window hide
    show cg 電信柱（夜） with dissolve
    window show
    "正太控就是有正太郎情结，"
    extend "\n即对少年产生性冲动或恋爱感情的人。"
    extend "\n也就是喜欢小男孩的意思。"
    show cg c1 帰宅する少年たち with fade
    "从他们肩上背着的球拍包来看，他们是网球社的？"
    extend "\n不愧是必吃社团！可口的孩子很多啊。"
    show cg c1 帰宅する少年たち２ with fade
...
label s00000154_00000159:
    ...
    tubasa "啊，好的，友君……。"
    window hide
    show cg 校門 at center with lm_crossfade
    window show
...
label s00000154_0000015A:
    ...
    window hide
    hide bg with dissolve
    show bg 商店街（夜） at center with dissolve
    window show
    "他们走过人行横道，进入了热闹的商业街。"
    "呼。兴奋过后，肚子也饿了啊。"
...
label s00000154_0000015C:
    ...
    window hide
    play sound "FX/風.ogg"
    show nori c2 謎の少年の誘い at center with fade
    window show
...
label s00000154_0000015D:
    ...
    window hide
    play music "懐かしさ.ogg"
    show bg リビング（夜） with Dissolve(1.2)
    window show
    mother "哎呀，欢迎回来。"
    extend "今天回来得挺早的啊。"
    extend "\n离开饭还有一会儿，等会儿再叫你吧。"
    ...
    hide bg with dissolve
    play sound "FX/ドアを開ける.ogg"
    show bg 主人公部屋（夜） at center with dissolve
    window show
    me "呼~累死了。"
    ...
    window hide
    play music "回想.ogg"
    show bg 学校（セピア） with Dissolve(2.0)
    window show
    "那个时候，我既没好好学习，也没谈过恋爱，\n真的就是只顾着玩了。"
    show bg 山（セピア） with Dissolve(1.0)
    "跑到附近的森林里探险，骑自行车到邻镇去……。"
    extend "\n嗯嗯，果然最无忧无虑的初中二年级，就是玩得最开心的时候啊。"
    show bg 教室（セピア） with Dissolve(1.0)
    "嗯……我初中二年级时班上做了什么项目来着？"
    extend "\n……对了对了，鬼屋。"
    ...
    show bg 学校（セピア） with Dissolve(1.0)
    window show
    ...
    "啊……真棒啊~。"
    window hide
    show bg 主人公部屋（夜） with Dissolve(2.0)
    window show
    "···"
    "然后，和传单一起拿出的另一样东西。\n是那个谜之美少年给我的糖。"
    window hide
    stop music fadeout 2.0
    show 飴 c4 魔法の飴玉 at center with dissolve
    window show
    "不管是什么愿望都可以实现的糖啊……。"
    "反正不过就是中二病发作的人恶作剧而已，\n刚好我手边缺点下酒菜，就吃了吧。"
    "我把糖扔进嘴里，咬碎，咽了下去。"
...
label s00000154_00000179:
    ...
    show cg 電信柱（夜） at center with dissolve
    window show
    unknown "你打算去哪里呢？"
    extend "\n没办法了，只能用强硬的手段了哦。"
    me "诶？"
    ...
    show cg remarkable with fade
    me "嗯咕！？唔咕咕咕！？？！"
    "好恶心……咕啾咕啾的液体钻进了我的嘴里。"
    stop music fadeout 4.0
    me "嗯嗯……嗯唔…。"
    "渐渐地，我的意识开始模糊，视线也朦胧起来。"
    hide cg with lm_wiperight
    hide nori with lm_wiperight
    hide bg with lm_wiperight
    pause 0.4
    "···。"
    window hide
    show bg 住宅街（夜） at center with Dissolve(0.7)
...
label s00000154_0000017A:
    ...
    extend "\n然后说『戴上这眼镜的话~』，"
    play sound "FX/キラキラ.ogg"
    show cg adult with Dissolve(0.3)
    extend "『和我签订契约吧~』之类的，"
    hide cg with dissolve
    ...
    "我回想起不久前还在身边的那名少年的面容。"
    extend "\n但是，那孩子很可爱啊。"
    show cg 電信柱（夜） at center with Dissolve(0.6)
    "……不如说，我更想和他，多聊聊，\n这是我想去实现的愿望。。"
    window hide
    hide bg with dissolve
    hide cg with dissolve
...
label s00000154_0000017B:
    ...
    "···"
    window hide
    show bg 地下牢 at center with Dissolve(2.4)
    ...
    window hide
    play sound "FX/戦い３.ogg"
    show bg キャンプファイヤー（火の粉） with Dissolve(0.4)
    pause 0.6
    play sound "FX/ファントム・ファイア.ogg"
    show bg ファントムファイアー with Dissolve(0.4)
    window show
    "砰啊啊啊啊啊啊啊啊啊！！！！！！"
    window hide
    show bg 地下牢 at center with Dissolve(0.2)
    play sound "FX/ビヨン.ogg"
    window show
    me "呜哇！！ 什么！？！？"
    extend "\n喂！！声音太大了我睡不着啊！！！"
    ...
    window hide
    show cg c90 at center with pixellate
    window show
    "说完，"
    "朔拿出几把小刀，向夕阳扔了过去。"
    show cg c90 with pixellate
    extend "\n朔的触手与小刀纷至沓来，战斗一触即发，"
    show cg c90 with lm_crossfade
    ...
    window hide
    show cg c91 1 at center with fade
    window show
    "咔嚓"
    "朔将刀刃抵在了我的脖子上。"
    me "诶……那，那个，朔先生……。"
...
label s00000154_0000017C:
    ...
    "说完，束缚着我身体的触手就放开了我。"
    window hide
    show bg 地下牢 at center with dissolve
    show yuuhi 3 at top with dissolve
    window show
    yuuhi "诶……"
    ...
    extend "\n哥哥似乎对你那色情的内裤很感兴趣哦。"
    window hide
    show cg c93 1 at center with fade
    window show
    play sound "FX/ビヨン.ogg"
    ...
    extend "\n只是一会儿就好，把短裤给我脱下来！！！"
    window hide
    show cg c93 3 with lm_crossfade
    window show
    "偷瞄"
    ...
    yuuhi "……就是现在！"
    play sound "FX/ファントム・ファイア.ogg"
    show cg ファントムファイアー at center with pixellate
    ...
    hide bg with fade
    pause 0.6
    show bg 地下牢 at center with Dissolve(0.7)
    pause 0.6
    show bg 朔ed with Dissolve(0.8)
    pause 1.3
    hide bg with dissolve
    pause 0.5
...
label s00000154_0000017D:
    ...
    window hide
    play sound "FX/風を切る.ogg"
    show cg c92 1 at center with fade
    window show
    nori "快，快住手！你，你这！！"
    play sound "FX/ビヨン.ogg"
    extend "\n喂，触手们！！！\n赶快阻止这些家伙！！！"
    ...
    window hide
    play sound "FX/戦い３.ogg"
    show cg キャンプファイヤー（火の粉） with Dissolve(0.4)
    pause 0.6
    play sound "FX/ファントム・ファイア.ogg"
    ...
    show cg ファントムファイアー at center with lm_crossfade
    window show
    "说着，夕阳在手掌上变出了一团小火焰。"
    yuuhi "这种事，一般人是办不到的吧？"
    ...
    "···。"
    window hide
    show bg 住宅街（夜） at center with Dissolve(0.8)
    play music "帰宅.ogg"
    window show
    "就这样，我们逃离了朔，顺利地来到了外面。"
    me "夕阳君，今天真是谢谢你了。"
    ...
    me "啊哈哈哈。"
    window hide
    show cg 夜の街 at center with Dissolve(0.7)
    window show
    "谈笑了一会儿，夕阳又离开去了别的地方。"
    extend "\n为了守护世界的和平，巡逻是必不可少的。"
    ...
    hide bg with fade
    pause 0.6
    show bg ファントムファイアー at center with Dissolve(0.7)
    pause 0.6
    show bg ユウヒed with Dissolve(0.8)
    pause 1.3
    hide bg with dissolve
    pause 0.5
    show bg 制作 at center with dissolve
