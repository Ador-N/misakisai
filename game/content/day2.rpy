...
label day2_layout:
    ...
    window hide
    show cg c33 2 at center with lm_crossfade
    window show
    clerk2 "忍君翼君，微笑微笑~！"
    tubasa_and_sinobu "……(笑)。"
    clerk1 "嗯，做得不错。"
...
label day2_supply:
    ...
    extend "\n你看，就像这样放在茶杯上\n然后从上方把茶壶里的红茶倒进去。"
    window hide
    show cg c68 1 at center with lm_crossfade
    window show
    saburo "哦哦……原来如此……"
    extend "\n哇好厉害啊！\n味道好香啊…。"
    "三朗闻着红茶的香气，一脸享受的样子……"
...
label day2_design_tomo:
    ...
    window hide
    show cg c11 at center with lm_crossfade
    window show
    me "这样就好了！"
    extend "\n嗯，很适合你！\n对吧？慎太郎。"
    sintarou "没错！"
...
label day2_design_sintarou:
    ...
    "才刚说完，我就伸出手环住慎太郎的脖子。"
    window hide
    show cg c25 at center with lm_crossfade
    window show
...
label day2_layout_tubasa:
    ...
    window hide
    show cg c42 1 at center with lm_crossfade
    window show
...
label day2_supply_saburo:
    ...
    hide sakuya with lm_crossfade
    hide 共 with lm_crossfade
    show saburo 2 at top with dissolve
    window show
    saburo "对吧？"
    extend "\n反正那方面是个人的自由，我也没什么说的。"
...
label day2_bad_end:
    ...
    hide bg with fade
    pause 0.6
    show bg dark at center with Dissolve(0.7)
    pause 0.6
